# -*- coding: utf-8 -*-
"""
Created on Wed Apr  4 19:02:40 2018
...
rtrees.train(train_data_mat, cv2.ml.ROW_SAMPLE, train_labels_mat)
rtrees.save('rtrees_data.dat')
t_train_end = time.time()
print ('Time taken to train {}'.format(t_train_end - t_train_start))



results = rtrees.predict(train_data_mat)
...
while(cap.isOpened()):
    ...
    for (x,y,w,h) in faces:
        ...
        result = rtrees.predict(test_data)
        emotion = result[1]
        emotion = emotion[0]
