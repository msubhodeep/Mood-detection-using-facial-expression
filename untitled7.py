# -*- coding: utf-8 -*-
"""
Created on Sun May 13 10:57:28 2018
...
while(cap.isOpened()):
    ...
    for (x,y,w,h) in faces:
        ...
        emotion = emotion[0]
        if emotion == 0:
            print("Try being happy it is a good feeling")
        if emotion == 1:
            print("Being angry is bad,happiness is for free")
        if emotion == 2:
            print("Your are near angry,smile please")
        if emotion == 3:
             print("Seems you are disgusted,smile a bit")
        if emotion == 4:
            print("Fear! Did you see a ghost? Calm down")
        if emotion == 5:
            print("Looks you are happy,wow")
        if emotion == 6:
            print("Surprise Suprise !!")
        if emotion == 7:
            print("Smile,Sadness is temporary")
