# -*- coding: utf-8 -*-
"""
Created on Wed May  9 02:01:55 2018
...
train_data_global,test_data_global,train_labels_global, test_labels_global = train_test_split(np.array(train_data),np.array(train_labels),test_size = 0.20,random_state = 0)
from sklearn.svm import SVC
classifier = SVC(kernel = 'rbf',random_state = 0)
classifier.fit(train_data_global,train_labels_global)
"""
...
print (format(int(correct)*100/len(results[1])))
